...
var options = {
  ...
  labels: ['<i class="fa fa-check"></i> Verify', ' <i class="fas fa-ban"></i> Unverify',  ],
  series: [34, 33,],
  colors: ['#1F78B4','#546A76',],
...
var chart = new ApexCharts(document.querySelector("#verify_twitter"), options);
...
var options = {
    ...
    // var series = document.getElementById("#neutral").nodeValue
    
		
		var options = {
          series: [document.getElementById("neutral").value],
          chart: {
          height: 250,
          type: 'radialBar',
        },
        ...
        /* Overall Score1*/
        var options1 = {
          series: [document.getElementById("positive").value],
          colors: ["#20E647"],
          chart: {
          height: 250,
          type: 'radialBar',
        ...
        labels: ['Possitive Sentiment  '],
        };
    var chart = new ApexCharts(document.querySelector("#overallscore1"), options1);
        chart.render();
        
        
        /* Overall Score2*/
        var options2 = {
          series: [document.getElementById("negative").value],
          colors: ["#FF0000"],
          chart: {
          height: 250,
          type: 'radialBar',
        ...
        var chart = new ApexCharts(document.querySelector("#overallscore2"), options2);
        chart.render();
